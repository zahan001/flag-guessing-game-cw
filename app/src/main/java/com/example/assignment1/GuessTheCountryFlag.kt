...
fun GuessFlagName(flagResourceIds: List<Int>,
    ...
    val correctCountryCode = remember { flagCountryCodeMap[correctFlagResourceId] }


    // Extracting the corresponding country code for the correct flag
    //val correctCountryCode = remember { countryMap.filterValues { it == countryMap[correctFlagResourceId.toString()] }.keys.first() }

    // Fetching the correct country name using the correct country code
    ...
    Column(
        ...
        Row { // Displaying 3 flags vertically
                ...
                FlagImage(
                    ...
                    onClick = {
                        if (!userAttempted) {
                            ...
                            setIsCorrect(flagCountryCodeMap[flag] == correctCountryCode)
                        }
                    }
                )
            }
        ...
        // Displaying message to the user based on their guess
        if (userAttempted) {
